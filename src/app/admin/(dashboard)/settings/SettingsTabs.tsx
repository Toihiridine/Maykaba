...
export default function SettingsTabs({ initialFiles, publicUrlPrefix, initialSettings }: SettingsTabsProps) {
  const [activeTab, setActiveTab] = useState<"general" | "stripe" | "media">("general");
