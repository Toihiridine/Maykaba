...
export default async function PartnerDashboardPage(props: { params: Promise<{ storeSlug: string }> }) {
  try {
    ...
    return (
      <div className="space-y-8 pb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Sales Chart Section */}
          <SalesChartSection completedOrders={completedOrders.map(o => {
            let dateStr = "";
            try {
              dateStr = o.createdAt ? new Date(o.createdAt).toISOString() : new Date().toISOString();
            } catch {
              dateStr = new Date().toISOString();
            }
            return { createdAt: dateStr, totalAmount: o.totalAmount || 0 };
          })} />
    ...
    return (
      <div className="p-10 bg-red-50 border border-red-200 rounded-2xl m-8">
        <h2 className="text-2xl font-bold text-red-700 mb-4">CRASH DETECTED IN PAGE.TSX</h2>
